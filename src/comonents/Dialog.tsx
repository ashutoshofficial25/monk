...
export default function Dialog({ open, title, onClose, children }: IProps) {
  ...
  return (
    ...
    >
      <div
        className="fixed inset-0 bg-[rgba(0,0,0,0.50)] "
        aria-hidden="true"
      ></div>

      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 md:w-[664px] w-full">
